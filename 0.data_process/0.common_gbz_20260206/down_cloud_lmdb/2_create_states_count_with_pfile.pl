...
my $dir_lib      = "$dir_pwd/lib_fb40_states";
my $dir_lib0     = "./lib_fb40"; mkdir($dir_lib0) if(!-e $dir_lib0);
my $nSplit       = 4;
my $states_list  = "/work1/asrdictt/taoyu/mlg/turkish/am/1_mle_mfc/final_s9k/states.list"; #### cdphone cluster: states.list.nosp; state cluster: states.list
