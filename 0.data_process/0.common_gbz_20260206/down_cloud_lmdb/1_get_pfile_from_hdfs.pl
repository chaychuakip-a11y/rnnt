...
my $nSplit       = 10;
my $nPart        = 100;
my $states_list  = "/raw15/asrdictt/permanent/zhyou2/202311_mlg_car/french/0.data_prepare/mle_yingchen15/states.list";  #### cdphone cluster: cdphone.map.list.nosp; state cluster: states.list
my $scp_filter   = "";
...
my $dir_lib      = "$dir_pwd/lib_fb40_3states";
...
foreach my $split_id(@split_id)
{
	...
	if(!-e "$file_norm.done" and -e "$pfile_fea")
	{
