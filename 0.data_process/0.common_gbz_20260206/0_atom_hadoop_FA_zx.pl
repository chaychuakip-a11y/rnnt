...
use share_hadoop;
my $jobname			= "mle_fa__trans"; # Here Set Job Name
my $jobqueue			= "asr_trans"; # Here Set The Job Queue Of Your Group
my $reduces_num			= 100;
my $input_hdfs_block_size	= 256 * 1024 * 1024;
my $hdfs_block_size		= 256 * 1024 * 1024;
my @hdir_srcs     = (
#*合并后原始数据-zx, 8053h
"/workdir/asrmlg/dasrmlg/yyhu7/bak_mingli18/import_punc_num/train_wav_mlf/french_final/zx_16k",
); # Here Set Your Input Path On Hdfs


my $input_dir = join(" -input ", @hdir_srcs);

my $local_output = "french_zx8053h_wav_fb75_mlefa";
my $output_dir		    = "/workdir/asrdictt/gasrdictt/zhyou2/mlg/202311_car/french/$local_output"; # Here Set Your Output Path On Hdfs
...
my $fst_bin_local = "/raw15/asrdictt/permanent/zhyou2/202311_mlg_car/french/0.data_prepare/gen_fst_bin/atom_FA_french_ly1213h_ly2k_xw696h_openSRC412h_fz1655h_ttsMusicVideoPoi_v16.word_dict_phone_nosp.add_pred_1gram/fst.bin";
...
my $file_mlf_sy		="/raw15/asrdictt/permanent/zhyou2/202311_mlg_car/french/0.data_prepare/check_oov/mlf_zx/lab.mlf_sy.nopunc";
