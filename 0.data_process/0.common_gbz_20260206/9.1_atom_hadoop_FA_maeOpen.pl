...
use share_hadoop;
my $jobname			= "mle_fa__maeOpen"; # Here Set Job Name
my $jobqueue			= "chime"; # Here Set The Job Queue Of Your Group
my $reduces_num			= 100;
my $input_hdfs_block_size	= 256 * 1024 * 1024;
my $hdfs_block_size		= 256 * 1024 * 1024;
my @hdir_srcs     = (
#*合并后原始数据-tx, 13362h
"/workdir/asrdictt/tasrdictt/zhyou2/mlg/202311_car/french/wav_mix_all_noisy_maeOpen_0.1",
); # Here Set Your Input Path On Hdfs


my $input_dir = join(" -input ", @hdir_srcs);

my $local_output = "wav_mix_all_noisy_maeOpen_0.1_mlefa";
