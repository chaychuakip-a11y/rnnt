...
my @hdir_src     = (
                    "/workdir/asrdictt/gasrdictt/zhyou2/mlg/202311_car/french/french_zx8053h_wav_fb75_mlefa/*-part-000*[0-1]", # 2/10
					"/workdir/asrdictt/gasrdictt/zhyou2/mlg/202311_car/french/french_tx13362h_wav_fb75_mlefa/*-part-000*[0-1]"
					);
my $hdir_out     = "/workdir/asrdictt/tasrdictt/zhyou2/mlg/202311_car/french/mlefa_mix_all_addnoise_byd_0.2";
my $hdir_src     = join(" -input ", @hdir_src);

my $noisedata    = "hdfs://mycluster/workdir/asrdictt/gasrdictt/zhyou2/mlg/202311_car/noises/noise_car_byd_rm3-4.pak/iflytek-20231116-part-00000";#IN
