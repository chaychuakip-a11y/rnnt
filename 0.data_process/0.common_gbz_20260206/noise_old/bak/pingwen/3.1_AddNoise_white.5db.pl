...
my @hdir_src     = (
                   "/workdir/asrmlg/gasrmlg/ddye2/italian_local/triphone_dnnfa/italy_zx_tx_10832h_triphone_dnnfa/*-part-0008[5-9]*", ## 1/8
                   );
my $hdir_out     = "/workdir/asrmlg/gasrmlg/ddye2/italian_local/triphone_dnnfa/italy_zx_tx_541h_triphone_dnnfa.writenoise_5db";
my $hdir_src     = join(" -input ", @hdir_src);

my $noisedata    = "hdfs://mycluster/workdir/asrdictt/dasrdictt/taoyu/noisedata/16k/WhiteNoise.raw.index.scp.tmp.pak.1";#IN
