...
#                   );
my @hdir_src     = (
                   "/workdir/asrmlg/gasrmlg/ddye2/italian_local/triphone_dnnfa/italy_zx_tx_10832h_triphone_dnnfa/*-part-0005[0-4]*",  # 1/2
                   );
my $hdir_out     = "/workdir/asrmlg/gasrmlg/ddye2/italian_local/triphone_dnnfa/italy_zx_tx_541h_triphone_dnnfa.twonoise_5db";
my $hdir_src     = join(" -input ", @hdir_src);

my $noisedata    = "hdfs://mycluster/workdir/asrmlg/dasrmlg/ddye2/noise_huanxing/twonoise/twonoise.scp.1.pak";#IN
