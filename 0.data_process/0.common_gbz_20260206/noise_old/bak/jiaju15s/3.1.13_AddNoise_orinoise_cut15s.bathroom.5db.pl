...
my $jobname0     = "AddNoise_orinoise_cut15s.bathroom";
...
#my @hdir_src     = (
#                   "/workdir/asrmlg/dasrmlg/ddye2/gmkws/japanese/dnnfa/japanese_tx_2165H_fb75_dnnfa/*-part-0000[0-3]*",  # 1/2
#                   );
my @hdir_src     = (
                   "/workdir/asrmlg/gasrmlg/ddye2/italian_local/triphone_dnnfa/italy_zx_tx_10832h_triphone_dnnfa/*-part-0006[5-9]*",  # 1/2
                   );
my $hdir_out     = "/workdir/asrmlg/gasrmlg/ddye2/italian_local/triphone_dnnfa/italy_zx_tx_541h_triphone_dnnfa.orinoise_cut15s.bathroom_5db";
my $hdir_src     = join(" -input ", @hdir_src);

my $noisedata    = "hdfs://mycluster/workdir/asrmlg/dasrmlg/ddye2/noise_huanxing/orinoise_cut15s.bathroom/orinoise_cut15s.bathroom.scp.1.pak";#IN
