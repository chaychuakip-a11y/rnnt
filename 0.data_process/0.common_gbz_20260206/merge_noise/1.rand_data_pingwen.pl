...
my @hdir_src     = (
"/workdir/asrmlg/dasrmlg/ddye2/noise_huanxing/onenoise_baizao/onenoise_baizao.scp.1.pak",    ##单点噪声-白噪声
"/workdir/asrdictt/dasrdictt/taoyu/noisedata/16k/WhiteNoise.raw.index.scp.tmp.pak.1",        ## 白噪声
"/workdir/asrmlg/dasrmlg/ddye2/noise_huanxing/onenoise_pingwen/onenoise_pingwen.scp.1.pak",  ##单点噪声-平稳噪声
);
my $hdir_out     = "/workdir/asrdictt/gasrdictt/zhyou2/mlg/202311_car/noises/noise_pingwen_baizao_mix_all.pak";
