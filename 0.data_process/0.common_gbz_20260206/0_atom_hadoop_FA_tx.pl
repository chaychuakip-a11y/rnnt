...
use share_hadoop;
my $jobname			= "mle_fa__dictt"; # Here Set Job Name
...
my @hdir_srcs     = (
#*合并后原始数据-tx, 13362h
"/workdir/asrmlg/dasrmlg/yyhu7/bak_mingli18/import_punc_num/train_wav_mlf/french_final/tx",
); # Here Set Your Input Path On Hdfs


my $input_dir = join(" -input ", @hdir_srcs);

my $local_output = "french_tx13362h_wav_fb75_mlefa";
...
my $file_mlf_sy		="/raw15/asrdictt/permanent/zhyou2/202311_mlg_car/french/0.data_prepare/check_oov/mlf_tx/lab.mlf_sy.nopunc";
