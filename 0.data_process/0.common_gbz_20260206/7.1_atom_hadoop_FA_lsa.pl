...
use share_hadoop;
my $jobname			= "mle_fa__lsa"; # Here Set Job Name
...
my @hdir_srcs     = (
#*合并后原始数据-tx, 13362h
"/workdir/asrdictt/tasrdictt/zhyou2/mlg/202311_car/french/wav_mix_all_noisy_lsaDenoise_0.2",
); # Here Set Your Input Path On Hdfs


my $input_dir = join(" -input ", @hdir_srcs);

my $local_output = "wav_mix_all_noisy_lsaDenoise_0.2_mlefa";
my $output_dir		    = "/workdir/asrdictt/tasrdictt/zhyou2/mlg/202311_car/french/$local_output"; # Here Set Your Output Path On Hdfs
...
my $file_mlf_sy		="/raw15/asrdictt/permanent/zhyou2/202311_mlg_car/french/data_prepare/check_oov/mlf_tx/lab.mlf_sy.nopunc";
