...
###配置输入
my @hdir_src     = (
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_speedup1.2_ampReduce_lsa_mae_fea_fa",
);
my $hdir_src     = join(" -input ", @hdir_src);

###配置输出
my $src_label      = "french_chezai_gbz_20260302_rand_speedup1.2_ampReduce_lsa_mae_fea_fa";
