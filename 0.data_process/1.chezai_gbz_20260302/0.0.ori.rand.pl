...
my $jobname           = "0.0.ori.rand";#SET
my $jobqueue          = "asr_dictt";#SET
my $num_reduce        = 100;
my $in_blocksize      = 1024*1024*1024;
my $block_size        = 64*1024*1024;
my $replication       = 2;

my @hdir_src     = (
###公版+车载高保真
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/french_chezai_gongban_tyky_fs_202410_202501", ###98.129h
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/NO1645_zeekr_french", ###7.001h
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/NO1571_byd_french", ###1.385h
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/NO1558_geely_french", ###6.153h
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/NO1507_byd_french", ###15.140h
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/NO1706_changan_french", ###14.163h
"/workdir/asrdictt/dasrdictt/hjwang11/en/src_wav/NO1583_changan_french", ###15.103h
                    );
my $hdir_out     = ("/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand");
my $hdir_src     = join(" -input ", @hdir_src);

#foreach my $hdir_cur(@hdir_src)
#{
#	system("wait_dir_hdfs.pl $hdir_cur/_SUCCESS");
#}
