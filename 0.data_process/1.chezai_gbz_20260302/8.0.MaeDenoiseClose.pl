...
my $jobname           = "8.0.MaeDenoiseClose";#SET
...
my @hdir_src = (
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_rm_head_44bytes/*9",
);
my $hdir_out          = "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_0.1_mae_close";
