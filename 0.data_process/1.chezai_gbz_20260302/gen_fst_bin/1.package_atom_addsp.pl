...
my $name = "french_ly1213h_ly2k_xw696h_openSRC412h_fz1655h_ttsMusicVideoPoi_v16.word_dict_phone_nosp.add_pred_20260302";

my $dir_root           = ".";
my $lm                 = "./$name.1gram";
my $dict               = "./$name";
my $hmmlist            = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/am/0.data_process/0.common_gbz_20260206/mle_yingchen15/hmmlist.final";
my $out_key            = "$name";
