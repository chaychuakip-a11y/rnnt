...
my @hdir_src     = (
                    "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa/*-part-0006*", # 1/10
                    );
my $hdir_out     = "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise/mlefa_mix_all_addnoise_duodian_0.1";
...
my $noisedata    = "hdfs://mycluster/workdir/spdictt/gspdictt/hjwang11/noise/noise_duodian_mix_all.pak/iflytek-20231116-part-00000";#IN
