...
my $jobname           = "4.2.ubfa.speedup";#SET
...
my @hdir_src     = (
                    "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_0.2_speedup1.2",
                   );
my $hdir_out     = ("/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_0.2_speedup1.2_fa");
