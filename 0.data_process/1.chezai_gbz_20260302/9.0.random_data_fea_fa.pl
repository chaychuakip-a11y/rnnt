...
my @hdir_src = (
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa", ###原始数据
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_rm_head_44bytes/*", ###加噪数据
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_0.2_speedup1.2_fa", ###原始数据变速
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_0.2_ampReduce", ###原始数据小音量
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_0.2_lsa_fa", ###加噪数据lsa降噪
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_0.1_mae_open_fa", ###加噪数据mae_open降噪
"/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_0.1_mae_close_fa", ###加噪数据mae_close降噪
);
my $hdir_out          = "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_speedup1.2_ampReduce_lsa_mae_fea_fa";
...
::CmdToLocal("$bin_selecttail wav fbnocmn40 mlf_sy mlf_fa_ph"),
