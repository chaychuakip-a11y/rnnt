...
my @hdir_src     = (
                    "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand/*[8-9]",
                   );
my $hdir_out     = ("/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_0.2_speedup1.2");
...
my $bin_wavspeed       = "$dir_bin/wav_speed_hadoop"; ##/lustre2/asr/yjjiang/jst-data/tools/wav_speed_hadoop/Debug/wav_speed_hadoop
