...
my $jobname           = "7.2.ubfa.MaeDenoiseOpen";#SET
...
my @hdir_src =(
                        "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_0.1_mae_open",
);
my $hdir_out          = "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_fa_addnoise_0.1_mae_open_fa";
