...
def run_multi_gpu(config, LOG):
    ...
    ##torchintx.clamp_module(model.encoder.conv2, clamp_weight_value=1, clamp_bias_value=6, clamp_output_value=8, clamp_dynamic_percent=1.0) # 150 70 30 15 8
    #torchintx.clamp_module(model.encoder.conv3, clamp_weight_value=1, clamp_bias_value=5, clamp_output_value=8, clamp_dynamic_percent=1.0) # 100
    ...
    torchintx.clamp_module(model.encoder.dnn_skip1, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=8, clamp_dynamic_percent=1.0)
    torchintx.clamp_module(model.encoder.dnn_skip2, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=8, clamp_dynamic_percent=1.0)
    torchintx.clamp_module(model.encoder.dnn_skip1, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=8, clamp_dynamic_percent=1.0)
    torchintx.clamp_module(model.encoder.dnn_skip2, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=8, clamp_dynamic_percent=1.0)
    torchintx.clamp_module(model.encoder.dnn_skip_out, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=None, clamp_dynamic_percent=1.0)#butiao out
    torchintx.clamp_module(model.phone_ce.ctc_dnn, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=8, clamp_dynamic_percent=1.0)
    torchintx.clamp_module(model.phone_ce.ctc_out, clamp_weight_value=2, clamp_bias_value=2, clamp_output_value=None, clamp_dynamic_percent=1.0)
...
def run_single_gpu(config, LOG):
    ...
    with torch.cuda.device(config["TrainSetting"].getint("LocalRank")):
        ...
        torchintx.disable_clamp(model.encoder.dnn_skip_out)
        #
        #torchintx.clamp_module(model.encoder.conv2, clamp_weight_value=2, clamp_bias_value=4, clamp_output_value=4, clamp_dynamic_percent=1.0) # 200   180  150 100    60cv10 50  70cv4 55
        #torchintx.clamp_module(model.encoder.conv3, clamp_weight_value=2, clamp_bias_value=6, clamp_output_value=6, clamp_dynamic_percent=1.0)#8
        ...
        #
        #torchintx.clamp_module(model.encoder.conv01, clamp_weight_value=2, clamp_bias_value=4, clamp_output_value=5, clamp_dynamic_percent=1.0)##ok
        #torchintx.clamp_module(model.encoder.conv02, clamp_weight_value=1, clamp_bias_value=6, clamp_output_value=8, clamp_dynamic_percent=1.0)#7 ok  10
        #torchintx.clamp_module(model.encoder.conv03, clamp_weight_value=1, clamp_bias_value=5, clamp_output_value=7, clamp_dynamic_percent=1.0)#30 OK
        #torchintx.clamp_module(model.encoder.conv04, clamp_weight_value=1, clamp_bias_value=1, clamp_output_value=1, clamp_dynamic_percent=1.0)#8  4  4  20
        #
        ...
        #
        #torchintx.clamp_module(model.encoder.dnn_skip1, clamp_weight_value=1, clamp_bias_value=2, clamp_output_value=4, clamp_dynamic_percent=1.0)
        #torchintx.clamp_module(model.encoder.dnn_skip2, clamp_weight_value=1, clamp_bias_value=2, clamp_output_value=2, clamp_dynamic_percent=1.0)
        #torchintx.clamp_module(model.encoder.dnn_skip_out, clamp_weight_value=1, clamp_bias_value=2, clamp_output_value=None, clamp_dynamic_percent=1.0)#butiao out
        #
        #torchintx.clamp_module(model.encoder.conv2, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=256, clamp_dynamic_percent=1.0) # 150 70 30 15 8
        #torchintx.clamp_module(model.encoder.conv3, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=256, clamp_dynamic_percent=1.0) # 100
        #torchintx.clamp_module(model.encoder.conv4, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=256, clamp_dynamic_percent=1.0)#5 loss2  3 loss2 10

        # #
        torchintx.clamp_module(model.encoder.conv01, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)##ok

        torchintx.clamp_module(model.encoder.conv02, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)#7 ok  10
        torchintx.clamp_module(model.encoder.conv03, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)#30 OK
        torchintx.clamp_module(model.encoder.conv04, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)#8  4  4  20
        
        torchintx.clamp_module(model.encoder.lstm, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.encoder.lstm2, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.encoder.lstm3, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        
        torchintx.clamp_module(model.decoder.lstm, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.decoder.lstm2, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        
        torchintx.clamp_module(model.decoder.output_proj, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        
        torchintx.clamp_module(model.joint.project_layer, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=None, clamp_dynamic_percent=1.0)#butiao out
        
        torchintx.clamp_module(model.encoder.dnn_skip1, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.encoder.dnn_skip2, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.encoder.dnn_skip1, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.encoder.dnn_skip2, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
        torchintx.clamp_module(model.encoder.dnn_skip_out, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=None, clamp_dynamic_percent=1.0)#butiao out
    #
...
def simple_train(model, optimizer, config, data_loader, LOG):
    ...
    tt_time = time.time()    
    for i, data_element in enumerate(data_loader):
        read_time = time.time() - tt_time
        print("read time: %.4f s" % read_time, flush=True)
        optimizer.zero_grad()
        # loss = trainer.forward(i, data_element, model)
        loss_dict = trainer.forward(i, data_element, model)
        loss = 0
