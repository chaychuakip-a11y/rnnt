...
def run_multi_gpu(config, LOG):
    ...
    #torchintx.clamp_module(model.encoder.conv2, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0) # 150 70 30 15 8
    #torchintx.clamp_module(model.encoder.conv3, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0) # 100
    #torchintx.clamp_module(model.encoder.conv4, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)#5 loss2  3 loss2 10


    # #
    torchintx.clamp_module(model.encoder.conv01, clamp_weight_value=12, clamp_bias_value=8, clamp_output_value=None, clamp_dynamic_percent=1.0)##ok
    ...
    torchintx.clamp_module(model.phone_ce.ctc_dnn, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=8, clamp_dynamic_percent=1.0)
    torchintx.clamp_module(model.phone_ce.ctc_out, clamp_weight_value=8, clamp_bias_value=8, clamp_output_value=None, clamp_dynamic_percent=1.0)
