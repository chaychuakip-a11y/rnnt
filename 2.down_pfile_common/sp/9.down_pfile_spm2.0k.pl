...
for(my $ii=0; $ii<1;$ii=$ii+1){
    my $num = $ARGV[0];
    my $dir_lib             = "/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_common_20260209_sp2.0k";  ###set
    ...
    my $mlf_sp_file         = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/am/1.get_mlf_sp_common/$num/out.mlf_sy.mlf.danzi.mlf_sp";  ###set
    ...
    my $inputdir            ="/workdir/asrdictt/tasrdictt/zhyou2/mlg/202311_car/french/dnnfa_fixmlf_addfangzhen_all_fbnocmn40/*$split_id";   ###set
