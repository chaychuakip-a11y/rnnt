...
my $hdir         = "/workdir/asrdictt/tasrdictt/zhyou2/mlg/202311_car/french/dnnfa_fixmlf_addfangzhen_all_fbnocmn40";  ###set
my $nSplit       = 1;
my $nPart        = 100;
...
##out
my $dir_pwd      = '/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_common_20260209_sp2.0k';  ###set
