...
for(my $ii=0; $ii<1;$ii=$ii+1){
    my $num = $ARGV[0];
    my $dir_lib             = "/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_tune_20260313_add_noise_sp2.0k";  ###set
    ...
    my $mlf_sp_file         = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/am/1.get_mlf_sp_tune_20260313_add_noise/$num/out.mlf_sy.mlf.danzi.mlf_sp.add_empty";  ###set
    ...
    my $inputdir            ="/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_common_1000h_merge_cz_400h_add_cn_noise5.7h_pure_noise95h_20260313/*$split_id";   ###set
