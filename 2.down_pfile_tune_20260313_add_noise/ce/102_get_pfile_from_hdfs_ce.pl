...
my $hdir         = "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_common_1000h_merge_cz_400h_add_cn_noise5.7h_pure_noise95h_20260313";  ###set
my $nSplit       = 1;
my $nPart        = 100;
...
##out
my $dir_pwd      = '/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_tune_20260313_add_noise_sp2.0k';  ###set
