...
for(my $ii=0; $ii<1;$ii=$ii+1){
    my $num = $ARGV[0];
    my $dir_lib             = "/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_tune_20260306_add_noise_sp2.0k";  ###set
    ...
    my $mlf_sp_file         = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/am/1.get_mlf_sp_tune_20260306_add_noise/$num/out.mlf_sy.mlf.danzi.mlf_sp.add_empty";  ###set

    my $descript_fea        = "fbnocmn40";
    my $descript_lab        = "mlf_sy";
    my $descript_lab_sp     = "mlf_sp";
    my $pak_mlf_hanzi_split = "/work1/asrdictt/hjwang11/aBak/clwu4/pak_mlf_hanzi_split";
    my $states_list         = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/spm_2000/states_list.french_onlyen.spm2.0k"; #####set
    my $map_list            = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/spm_2000/states_list.french_onlyen.spm2.0k.map";  #####set
    my $bad_list            = "./list_bad.txt";
    my $bin_fea             = "/work1/asrdictt/hjwang11/aBak/clwu4/bin/raw_fea_fbk40";
    my $bin_fea_cfg         = "/work1/asrdictt/hjwang11/aBak/clwu4/raw.16K.fea.config.fb40";
    ...
    my $inputdir            ="/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_common_1000h_merge_cz_400h_add_cn_noise5.7h_pure_noise190h_20260306/*$split_id";   ###set
