...
excluded_chars = [".", "..", "<s>", "</s>", "،", ".", "؟", "!", "؛", "douhao", "juhao", "wenhao", "gantanhao", "?", "!"]  # 要排除的字符列表
diatonic_notes = {
    'ً':'',
    'ٍ':'',
    'َ':'',
...
replace_dict = {}
# ## 读外部dict
# with open('/raw15/asrdictt/permanent/zhyou2/202311_mlg_car/turkish/0_data_prepare/spm/res/Tr_hc_i_ı.maplist.check', 'r') as f:
#     for line in f:
#         # 移除每行末尾的换行符，并使用冒号分割键值对
...
for line in lines:
    ...
    if line.endswith(".mlf_sy\""):
        ...
        modified_lines_nopunc = []     
        modified_lines_danzi = []  
        content = line[:line.find(".mlf_sy\"")]  # 获取前面的内容并去掉开头的引号和空格
