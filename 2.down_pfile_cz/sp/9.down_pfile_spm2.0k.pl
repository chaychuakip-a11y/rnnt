...
for(my $ii=0; $ii<1;$ii=$ii+1){
    my $num = $ARGV[0];
    my $dir_lib             = "/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_cz_20260209_sp2.0k";  ###set
    ...
    my $mlf_sp_file         = "/raw15/asrdictt/permanent/hjwang11/multilingual/french/rnnt/am/1.get_mlf_sp_cz/$num/out.mlf_sy.mlf.danzi.mlf_sp";  ###set
    ...
    my $inputdir            ="/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_speedup1.2_ampReduce_lsa_mae_fea_fa/*$split_id";   ###set
