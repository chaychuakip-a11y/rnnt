...
my $hdir         = "/workdir/asrdictt/dasrdictt/hjwang11/chezai/french/french_chezai_gbz_20260302_rand_speedup1.2_ampReduce_lsa_mae_fea_fa";  ###set
my $nSplit       = 1;
my $nPart        = 100;
...
##out
my $dir_pwd      = '/raw15/asrdictt/permanent/hjwang11/traindata/mlg20260210/french/car_fr_cz_20260209_sp2.0k';  ###set
