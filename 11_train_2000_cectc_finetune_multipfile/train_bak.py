...
if __name__ == "__main__":
    ...
    if os.path.exists(train_dir + "/" + sys.argv[1]):
        ...
        os.system("mv {} ./{}/".format(train_dir + "/train_fun.py", train_dir + "/.files_back/"))
        os.system("mv {} ./{}/".format(train_dir + "/union_dataloader.py", train_dir + "/.files_back/"))
        
    os.system("cp {} ./{}/".format(sys.argv[1], train_dir))
    os.system("cp {} ./{}/".format(train_net + ".py", train_dir))
    os.system("cp {} ./{}/".format("./asr/train/train_fun.py", train_dir))
    os.system("cp {} ./{}/".format("./asr/data/union_dataloader.py", train_dir))
