...
def gen_part_list(config):
    ...
    initnum = config["TrainSetting"].getint("InitSent")
    DistributionDict["Init"] = {}
    DistributionDict["Init"]['0'] = "{0}-{1}".format(0, initnum)
